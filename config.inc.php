...
#################################
$mrbs_admin = "Timesheet Admin";
$mrbs_admin_email = "yoursun0@gmail.com";
...
$mrbs_company = "Consumer Search Group";
...
# notification.
$url_base = "https://localhost/timesheet";
...
# "@domain.com").
define ("MAIL_DOMAIN", '@consumersearch-group.com');
...
# backend).
define ("SMTP_HOST", "mail.cshk.com");
...
define ("MAIL_RECIPIENTS", '"Jessica"<jessica.szeto@consumersearch-group.com>,"Cindy"<cindy.lo@consumersearch-group.com>');

# Set email address of the Carbon Copy field. Default is ''. You can define
# more than one recipient (see MAIL_RECIPIENTS)
# define ("MAIL_CC", 'jessica.szeto@consumersearch-group.com');
define ("MAIL_CC", '');

# Set the content of the Subject field for added/changed entries.
$mail["subject"] = "Entry added/changed for $mrbs_company Timesheet (HK)";

# Set the content of the Subject field for deleted fields.
$mail["subject_delete"] = "Entry deleted for $mrbs_company Timesheet (HK)";

# Set the content of the message when a new entry is booked. What you type
# here will be added at the top of the message body.
$mail["new_entry"] = "A new entry has been inputed, here are the details:";
...
$typel["A"] = get_vocab("type_A");
$typel["B"] = get_vocab("type_B");
$typel["C"] = get_vocab("type_C");
$typel["D"] = get_vocab("type_D");
$typel["E"] = get_vocab("type_E");
$typel["F"] = get_vocab("type_F");
$typel["G"] = get_vocab("type_G");
$typel["H"] = get_vocab("type_H");
$typel["I"] = get_vocab("type_I");
$typel["Z"] = get_vocab("type_Z");
...
$tbl_last_update  = $db_tbl_prefix . "last_update";
$tbl_permission  = $db_tbl_prefix . "permission";
$tbl_approve  = $db_tbl_prefix . "approve";
$tbl_holidays = $db_tbl_prefix . 'holidays';

// $allowed_ip_prefix[] = "192.168.1.";


session_name('timesheet');
?>