...
if(isset($all_day) && ($all_day == "yes"))
{
    ...
    else
    {
        ...
        $end_minutes = $eveningends_minutes + $morningstarts_minutes + $resolution;
...
if(empty($err))
{
	...
	lastUpdate(getUserName());
    
    # Now its all done go back to the day view
    Header("Location: week.php?year=$year&month=$month&area=$area&room=$room_id");
    exit;
}
