...
$mrbs_admin_email = "timesheet.hk@cshk.com";
...
define ("MAIL_RECIPIENTS", '"Jessica"<jessica.szeto@cshk.com>,"Cindy"<cindy.lo@cshk.com>');

# Set email address of the Carbon Copy field. Default is ''. You can define
# more than one recipient (see MAIL_RECIPIENTS)
# define ("MAIL_CC", 'jessica.szeto@cshk.com');
define ("MAIL_CC", '');
